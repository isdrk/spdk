...
def add_parser(subparsers):
    ...
    def fsdev_set_opts(args):
        print(args.client.fsdev_set_opts(max_source_id=args.max_source_id,
    ...
    def fsdev_get_fsdevs(args):
        print_dict(args.client.fsdev_get_fsdevs(name=args.name if args.name else None))
    ...
    def fsdev_get_iostat(args):
        print_json(args.client.fsdev_get_iostat(name=args.name if args.name else None, per_channel=args.per_channel))
    ...
    def fsdev_reset_iostat(args):
        print(args.client.fsdev_reset_iostat(name=args.name if args.name else None))
    ...
    def fsdev_set_delays(args):
        print_json(args.client.fsdev_set_delays(name=args.name if args.name else None, submit=args.submit,
    ...
    def fsdev_aio_set_options(args):
        print(args.client.fsdev_aio_set_options(max_io_depth=args.max_io_depth, enable_io_uring=args.enable_io_uring))
