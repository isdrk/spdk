...
def bdev_set_options(client, bdev_io_pool_size=None, bdev_io_cache_size=None,
                     bdev_auto_examine=None, bdev_rw_bypass=None, iobuf_small_cache_size=None,
    ...
    Args:
        ...
        bdev_rw_bypass: global tweak to enable/disable bdev bypass for all bdev modules (optional)
    ...
    if bdev_rw_bypass is not None:
        params['bdev_rw_bypass'] = bdev_rw_bypass
...
def bdev_malloc_create(client, num_blocks, block_size, physical_block_size=None, name=None, uuid=None, optimal_io_boundary=None,
    ...
    if disable_verify_pi:
        params['disable_verify_pi'] = disable_verify_pi
...
def bdev_null_create(client, num_blocks, block_size, name, physical_block_size=None, uuid=None, md_size=None,
                     ...
                     preferred_unmap_alignment=None, preferred_unmap_granularity=None, zero_copy=None):
    ...
    Args:
        ...
        zero_copy: Enable Zero-copy, use given IB device or leave empty to use default (optional)
    Returns:
        Name of created block device.
    """
    params = dict()
...
def bdev_passthru_create(client, base_bdev_name, name, uuid=None, hide_metadata=None):
    """Construct a pass-through block device.
    Args:
        base_bdev_name: name of the existing bdev
        name: name of block device
        uuid: UUID of block device (optional)
        hide_metadata: Enable hide_metadata option to the base bdev (optional)
    Returns:
        Name of created block device.
    """
    params = dict()
    ...
    if hide_metadata is not None:
        params['hide_metadata'] = hide_metadata
