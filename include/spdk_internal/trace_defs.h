...
#define TRACE_GROUP_NVMF_RDMA_OFFLOAD	0x15
...
#define TRACE_RDMA_REQUEST_STATE_NEED_DATA_WR				SPDK_TPOINT_ID(TRACE_GROUP_NVMF_RDMA, 0x14)
#define TRACE_RDMA_REQUEST_STATE_NEED_ACCEL_TASK			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_RDMA, 0x15)
