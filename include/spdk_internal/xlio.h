...
#define xlio_freeaddrinfo(...) freeaddrinfo(__VA_ARGS__)
#define xlio_gai_strerror(...) gai_strerror(__VA_ARGS__)
#define xlio_init_ex(...) g_xlio_ops.xlio_init_ex(__VA_ARGS__)
#define xlio_poll_group_create(...) g_xlio_ops.xlio_poll_group_create(__VA_ARGS__)
#define xlio_poll_group_destroy(...) g_xlio_ops.xlio_poll_group_destroy(__VA_ARGS__)
#define xlio_poll_group_update(...) g_xlio_ops.xlio_poll_group_update(__VA_ARGS__)
#define xlio_poll_group_poll(...) g_xlio_ops.xlio_poll_group_poll(__VA_ARGS__)
#define xlio_socket_create(...) g_xlio_ops.xlio_socket_create(__VA_ARGS__)
#define xlio_socket_destroy(...) g_xlio_ops.xlio_socket_destroy(__VA_ARGS__)
#define xlio_socket_update(...) g_xlio_ops.xlio_socket_update(__VA_ARGS__)
#define xlio_socket_setsockopt(...) g_xlio_ops.xlio_socket_setsockopt(__VA_ARGS__)
#define xlio_socket_getsockname(...) g_xlio_ops.xlio_socket_getsockname(__VA_ARGS__)
#define xlio_socket_getpeername(...) g_xlio_ops.xlio_socket_getpeername(__VA_ARGS__)
#define xlio_socket_bind(...) g_xlio_ops.xlio_socket_bind(__VA_ARGS__)
#define xlio_socket_connect(...) g_xlio_ops.xlio_socket_connect(__VA_ARGS__)
#define xlio_socket_listen(...) g_xlio_ops.xlio_socket_listen(__VA_ARGS__)
#define xlio_socket_get_pd(...) g_xlio_ops.xlio_socket_get_pd(__VA_ARGS__)
#define xlio_socket_detach_group(...) g_xlio_ops.xlio_socket_detach_group(__VA_ARGS__)
#define xlio_socket_attach_group(...) g_xlio_ops.xlio_socket_attach_group(__VA_ARGS__)
#define xlio_socket_send(...) g_xlio_ops.xlio_socket_send(__VA_ARGS__)
#define xlio_socket_sendv(...) g_xlio_ops.xlio_socket_sendv(__VA_ARGS__)
#define xlio_poll_group_flush(...) g_xlio_ops.xlio_poll_group_flush(__VA_ARGS__)
#define xlio_socket_flush(...) g_xlio_ops.xlio_socket_flush(__VA_ARGS__)
#define xlio_socket_buf_free(...) g_xlio_ops.xlio_socket_buf_free(__VA_ARGS__)
#define xlio_poll_group_buf_free(...) g_xlio_ops.xlio_poll_group_buf_free(__VA_ARGS__)
