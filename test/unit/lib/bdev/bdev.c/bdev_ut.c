...
DEFINE_STUB_V(spdk_bdev_group_get_qos_rate_limits, (struct spdk_bdev_group *group, uint64_t *limits));
DEFINE_STUB(bdev_group_get_qos_limits, struct bdev_qos_limits *, (struct spdk_bdev_group *group), NULL);
DEFINE_STUB(bdev_qos_limits_queue_io, bool, (struct bdev_qos_limits *limits, struct spdk_bdev_io *bdev_io), true);
DEFINE_STUB_V(bdev_qos_limits_rewind, (struct bdev_qos_limits *limits, struct spdk_bdev_io *bdev_io));
...
DEFINE_STUB(bdev_qos_limits_check_disabled, bool, (const uint64_t *new_limits), false);
