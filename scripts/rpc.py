...
if __name__ == "__main__":
    ...
    def bdev_nvme_transport_statistics(args):
        print_dict(rpc.bdev.bdev_nvme_transport_statistics(args.client))

    p = subparsers.add_parser('bdev_nvme_transport_statistics',
                              help='Get bdev_nvme poll group transport statistics')
    p.set_defaults(func=bdev_nvme_transport_statistics)
