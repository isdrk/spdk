    ...
    *** Mutually exclusive with --disable-chap ***""", action='store_true')
    ...
    def fsdev_set_opts(args):
        print(rpc.fsdev.fsdev_set_opts(args.client, fsdev_io_pool_size=args.fsdev_io_pool_size,
                                       fsdev_io_cache_size=args.fsdev_io_cache_size, max_num_sources=args.max_num_sources))
    ...
    p.add_argument('--max-num-sources', help='Max number of sources (1-1024)', type=int, choices=range(1, 1024), metavar="[1-1024]")
